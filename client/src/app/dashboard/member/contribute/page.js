...
function ContributionFiling(props) {
  ...
  const { resetAllSelectedFields, changeSSSAmountOfPeriod } = props;
  ...
  const submitContribution = async () => {
    ...
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_API_URL}/contributions/individual/file-contribution`,
      {
        method: "POST",
        credentials: "include",
    ...
    if (result.success) {
      window.location.href = "/dashboard/member/pay";
    }
  };
